INSERT INTO CLIENT (ID, NAME, BIRTH_DATE, PASSWORD, ROLE)
VALUES (1, 'TED', '1985-03-26', 'password_ted', 2),
       (2, 'ROBIN', '1989-08-10', 'password_robin', 2),
       (3, 'LILY', '1986-03-26', 'password_lily', 2),
       (4, 'MARSHAL', '1983-03-26', 'password_marshal', 2),
       (5, 'BARNEY', '1982-03-26', 'password_barney', 1),
       (6, 'VICTORIA', '1988-03-26', 'password_victoria', 2),
       (7, 'CARL', '1980-03-26', 'password_carl', 1),
       (8, 'STEPHANIE', '1990-03-26', 'password_stephanie', 2);
